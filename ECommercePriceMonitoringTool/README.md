...
![Product textbox](static/images/img.png)
![Product Search](static/images/product-search.png)
![Product Display](static/images/product-display.png)
*Search interface showing Amazon product results*
